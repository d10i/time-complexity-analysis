...
public class MeasurementCollectionNodeAveragerTest {
  @Test
  public void testApply() throws Exception {
    ...
    final Measurement actualMeasurement = measurementCollectionTree.map(MergeableTree::new, new MeasurementCollectionNodeAverager<>()).getRootNode().getData();
