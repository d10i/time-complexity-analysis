...
public class MeasurementListNodeAveragerTest {
  @Test
  public void testApply() throws Exception {
    ...
    final Measurement actualMeasurement = measurementListTree.map(MergeableTree::new, new MeasurementListNodeAverager<>()).getRootNode().getData();

    assertEquals("Expected correct count", 1.0d, actualMeasurement.getCount(), 0.0000001d);
    assertEquals("Expected correct total", 2128431.3725490198d, actualMeasurement.getTotal(), 0.0000001d);
  }
}
