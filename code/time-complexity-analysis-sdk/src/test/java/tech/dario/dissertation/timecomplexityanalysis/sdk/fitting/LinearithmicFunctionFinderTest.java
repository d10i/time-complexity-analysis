...
public class LinearithmicFunctionFinderTest {
  ...
  public void findFittingFunction() throws Exception {
    ...
    FittingFunction fittingFunction = linearithmicFunctionFinder.findFittingFunction(new WeightedObservedPoints() {{
      add(1.0d, f(1.0d));
      add(2.0d, f(2.0d));
      add(5.0d, f(5.0d));
      add(10.0d, f(10.0d));
    ...
    assertEquals("Expected correct string representation", "2.000 * n * ln(n) + 6.000 [rms: 0.000]", fittingFunction.getStringRepresentation());
  }
